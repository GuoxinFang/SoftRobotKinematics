...
typedef enum select_type {NODE, EDGE, FACE};

class InteractiveTool : public GLKMouseTool
{
public:
    InteractiveTool(GLKLib *pGLKLib, QMeshPatch *meshPatch_,  GLKMouseTool *mouseTool, select_type selectType);
    InteractiveTool(GLKLib *pGLKLib, GLKObList *polygenMeshList,  GLKMouseTool *mouseTool, select_type selectType);
